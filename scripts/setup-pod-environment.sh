...
echo "   ./scripts/run-tests.sh sync      # Upload/Download test (3GB default)"
echo ""
echo "3. Custom file size test:"
echo ""
echo "   export TEST_FILE_SIZE_GB=10"
echo "   ./scripts/run-tests.sh full      # Run 10GB test"
echo "   ./scripts/run-tests.sh sync      # Run 10GB upload/download test"
echo ""
echo "Expected speeds on Runpod pod: 100-400 MB/s (with parallel transfers)"
echo ""